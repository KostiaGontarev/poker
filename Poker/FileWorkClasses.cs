...
namespace Poker
{
    class Saver
    {
        ...
        {
            if (game.table == null) System.Windows.Forms.MessageBox.Show("Нечего сохранять!", "Игра ещё не началась!");
        ...
        protected void saver_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            mainform.lbGameLog.Items.Insert(0, "Игра сохранена до текущей руки!");
