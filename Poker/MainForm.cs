...
namespace Poker
{
    public partial class MainForm : Form, GameResetInterface
    {
        ...
        {
            DialogResult r = MessageBox.Show("Вы действительно хотите выйти?", "Уже уходите?", MessageBoxButtons.OKCancel);
        ...
        private void статистикаToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Вы ещё не играли!", "Статистика отсутствует");
