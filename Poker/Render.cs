...
namespace Poker
{
    class Render : GameResetInterface
    {
            ...
            else
            {
                ...
                if ((game.table.gamelog.getMove(0).move == Movements.WinHandsUp)||(game.table.mainplayer.AllIn))
                {
                    ...
                    if (game.table.gamelog.getMove(0).move == Movements.WinHandsUp) 
                         MessageBox.Show(game.table.gamelog.getMove(0).player.Name + " выиграл раздачу, собрав " + game.table.gamelog.getMove(0).player.cards.ToString() + "!", "Победа!");
                }
            }
        }
        private void game_LostUpdateControls(object sender, EventArgs e)
        {
            ...
            mainform.labelBank.Text = "Банк: " + game.table.Bank.ToString();
            ...
            else mainform.labelTableAIBet.Text = "Ставка: " + game.table.players[0].stepBet.ToString();
